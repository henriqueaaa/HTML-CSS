...
Atividade 1 - Criação de página HTML
...
LINKS
- Foram utilizados dois tipos de links, o link externo → direciona para um site sobre HTML e abre em nova aba e link interno → permite voltar ao topo da página.

IMAGEM
- A página possui uma imagem da logo do HTML utilizando: - "src" → caminho da imagem; - "alt" → descrição da imagem para acessibilidade.

TECNOLOGIA
- A tecnologia utilizada foi o HTML 5, 
